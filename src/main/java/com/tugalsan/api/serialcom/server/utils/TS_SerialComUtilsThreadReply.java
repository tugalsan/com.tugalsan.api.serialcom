...
public class TS_SerialComUtilsThreadReply implements TGS_RunnableType1<TS_ThreadSyncTrigger> {
    ...
    private TS_SerialComUtilsThreadReply(TS_ThreadSyncTrigger killTrigger, SerialPort serialPort, TGS_RunnableType1<String> onReply) {
        this.killTrigger = killTrigger;
        this.serialPort = serialPort;
        this.onReply = onReply;
    }

    public static TS_SerialComUtilsThreadReply of(TS_ThreadSyncTrigger killTrigger, SerialPort serialPort, TGS_RunnableType1<String> onReply) {
