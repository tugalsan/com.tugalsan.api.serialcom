...
public class TS_SerialComOnReply {
    ...
    private TS_SerialComOnReply(TS_SerialComOnConnectError onConnectError, TGS_ExecutableType1<String> onReply_customMessageBroker) {
        this.onConnectError = onConnectError;
    ...
    final protected TGS_ExecutableType1<String> onReply_customMessageBroker;
    final protected int defaultMessageBrokerMessageSize;

    public static TS_SerialComOnReply of(TS_SerialComOnConnectError onConnectError, TGS_ExecutableType1<String> onReply_customMessageBroker) {
    ...
    public boolean onSuccess_useAndClose_connection(TGS_ExecutableType1<TS_SerialComConnection> con) {
        var connection = connect_AutoClosable();
        return connection.useAndClose_WithCustomMessageBroker(con);
    }

    public boolean onSuccess_useAndClose_defaultMessageBroker(TGS_ExecutableType2<TS_SerialComConnection, TS_SerialComMessageBroker> con_mb) {
        var connection = connect_AutoClosable();
