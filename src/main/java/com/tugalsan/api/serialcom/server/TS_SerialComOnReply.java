...
public class TS_SerialComOnReply {
    ...
    private TS_SerialComOnReply(TS_SerialComOnConnectError onConnectError, TGS_CallableType1Void<String> onReply_customMessageBroker) {
        this.onConnectError = onConnectError;
    ...
    final protected TGS_CallableType1Void<String> onReply_customMessageBroker;
    final protected int defaultMessageBrokerMessageSize;

    public static TS_SerialComOnReply of(TS_SerialComOnConnectError onConnectError, TGS_CallableType1Void<String> onReply_customMessageBroker) {
    ...
    public boolean onSuccess_useAndClose_connection(TS_ThreadSyncTrigger killTrigger, TGS_CallableType1Void<TS_SerialComConnection> con) {
        return TGS_UnSafe.call(() -> connect_AutoClosable(killTrigger).useAndClose_WithCustomMessageBroker(con), e -> false);
    }

    public boolean onSuccess_useAndClose_defaultMessageBroker(TS_ThreadSyncTrigger killTrigger, TGS_CallableType2Void<TS_SerialComConnection, TS_SerialComMessageBroker> con_mb) {
